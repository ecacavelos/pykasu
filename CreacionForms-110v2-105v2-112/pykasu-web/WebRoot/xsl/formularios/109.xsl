										...
										<tr>
											...
											<td vAlign="top" width="636">
												<table class="declaracion">
													<tbody>
														<tr>
															<th class="bordevacio">PARA EMPRESAS O ENTIDADES QUE REALICEN RETENCIONES EN CARACTER DE PAGO A CUENTA Y PAGO UNICO Y DEFINITIVO</th>
														</tr>
													</tbody>
												</table>
											</td>
													...
													<tbody>
														<tr>
															...
															<th class="bordevacio" style="width: 95%">
																<p align="left">RUBRO 1 IMPUESTO A LA RENTA COMERCIAL, INDUSTRIAL O DE SERVICIOS</p>
															</th>
														...
														<tr>
															<td class="borde">a</td>
															<td class="borde">Retenciones en carácter de Pago Único y Definitivo por distribución de utilidades o dividendos, remesados a personas o entidades del exterior que no posean sucursales en el país</td>
														...
														<tr>
															<td class="borde">c</td>
															<td class="borde">Retenciones en carácter de Pago Único y Defintivo por primas de seguro a empresas del exterior que no posean sucursales en el país</td>
														...
														<tr>
															...
															<td class="borde"><xsl:call-template name="itemNumerico">
																	<xsl:with-param name="pNombre">C14</xsl:with-param>
																	<xsl:with-param name="pValor"><xsl:value-of select="declaracion/detalle/C14"/></xsl:with-param>
														...
														<tr>
															<td class="borde">f</td>
															<td class="borde">Retenciones y Percepciones en caracter de pago unico y definitivo por otros conceptos no incluidos en los incisos anteriores</td>
															<td class="borde">15</td>
															<td class="borde"><xsl:call-template name="itemNumerico">
																	<xsl:with-param name="pNombre">C15</xsl:with-param>
																	<xsl:with-param name="pValor"><xsl:value-of select="declaracion/detalle/C15"/></xsl:with-param>
																	<xsl:with-param name="pModo"><xsl:value-of select="$Modo"/></xsl:with-param>
																</xsl:call-template>
															</td>
														</tr>
														<tr>
															...
															<td class="borde"><xsl:call-template name="itemNumerico">
																	...
																	<xsl:with-param name="pValor"><xsl:value-of select="declaracion/detalle/C16"/></xsl:with-param>
																	<xsl:with-param name="pModo"><xsl:value-of select="$Modo"/></xsl:with-param>
																</xsl:call-template>
															</td>
														</tr>
														<tr>
															...
															<td class="borde"><xsl:call-template name="itemNumerico">
																	...
																	<xsl:with-param name="pValor"><xsl:value-of select="declaracion/detalle/C17"/></xsl:with-param>
																	<xsl:with-param name="pModo"><xsl:value-of select="$Modo"/></xsl:with-param>
																</xsl:call-template>
															</td>
														</tr>
														<tr>
															...
															<td class="borde"><xsl:call-template name="itemNumerico">
																	...
																	<xsl:with-param name="pValor"><xsl:value-of select="declaracion/detalle/C18"/></xsl:with-param>
																	<xsl:with-param name="pModo"><xsl:value-of select="$Modo"/></xsl:with-param>
																</xsl:call-template>
															</td>
														</tr>
														<tr>
															<td class="borde">j</td>
															<td class="borde">Total de retenciones y percepciones en carácter de pago a cuenta (Inc. h+i)</td>
															<td class="borde">19</td>
															<td class="borde"><xsl:call-template name="itemNumerico">
																	<xsl:with-param name="pNombre">C19</xsl:with-param>
																	<xsl:with-param name="pValor"><xsl:value-of select="declaracion/detalle/C19"/></xsl:with-param>
																	<xsl:with-param name="pModo"><xsl:value-of select="$Modo"/></xsl:with-param>
																</xsl:call-template>
															</td>
														</tr>
														<tr>
															...
															<td class="borde"><xsl:call-template name="itemNumerico">
																	...
																	<xsl:with-param name="pValor"><xsl:value-of select="declaracion/detalle/C20"/></xsl:with-param>
																	<xsl:with-param name="pModo"><xsl:value-of select="$Modo"/></xsl:with-param>
																</xsl:call-template>
															</td>
														</tr>
											...
											<table class="declaracion">
												<tbody>
													<tr>
														<th class="bordevacio">INC</th>
														<th class="bordevacio" style="width: 95%">
															<p align="left">RUBRO 2 impuesto a la renta del pequeño contribuyente</p>
														</th>
													...
													<tr>
														...
														<td class="borde"><xsl:call-template name="itemNumerico">
																...
																<xsl:with-param name="pValor"><xsl:value-of select="declaracion/detalle/C21"/></xsl:with-param>
																<xsl:with-param name="pModo"><xsl:value-of select="$Modo"/></xsl:with-param>
															</xsl:call-template>
														</td>
													</tr>
													<tr>
														...
														<td class="borde"><xsl:call-template name="itemNumerico">
																...
																<xsl:with-param name="pValor"><xsl:value-of select="declaracion/detalle/C22"/></xsl:with-param>
																<xsl:with-param name="pModo"><xsl:value-of select="$Modo"/></xsl:with-param>
															</xsl:call-template>
														</td>
													</tr>
													<tr>
														...
														<td class="borde"><xsl:call-template name="itemNumerico">
																...
																<xsl:with-param name="pValor"><xsl:value-of select="declaracion/detalle/C23"/></xsl:with-param>
																<xsl:with-param name="pModo"><xsl:value-of select="$Modo"/></xsl:with-param>
															</xsl:call-template>
														</td>
													</tr>
											...
											<table class="declaracion">
												<tbody>
													<tr>
														<th class="bordevacio">INC</th>
														<th class="bordevacio" style="width: 95%">
															<p align="left">RUBRO 3 impuesto a la renta del servicio de caracter personal</p>
														</th>
														<th class="bordevacio" colSpan="2">
															<p align="center">importe</p>
														</th>
													...
													<tr>
														...
														<td class="borde"><xsl:call-template name="itemNumerico">
																...
																<xsl:with-param name="pValor"><xsl:value-of select="declaracion/detalle/C24"/></xsl:with-param>
																<xsl:with-param name="pModo"><xsl:value-of select="$Modo"/></xsl:with-param>
															</xsl:call-template>
														</td>
													</tr>
													<tr>
														...
														<td class="borde"><xsl:call-template name="itemNumerico">
																...
																<xsl:with-param name="pValor"><xsl:value-of select="declaracion/detalle/C25"/></xsl:with-param>
																<xsl:with-param name="pModo"><xsl:value-of select="$Modo"/></xsl:with-param>
															</xsl:call-template>
														</td>
													</tr>
													<tr>
														...
														<td class="borde"><xsl:call-template name="itemNumerico">
																...
																<xsl:with-param name="pValor"><xsl:value-of select="declaracion/detalle/C26"/></xsl:with-param>
																<xsl:with-param name="pModo"><xsl:value-of select="$Modo"/></xsl:with-param>
															</xsl:call-template>
														</td>
													</tr>
											...
											<table class="declaracion">
												<tbody>
													<tr>
														<th>INC</th>
														<th style="width: 95%">
															<p align="left">RUBRO 4 impuesto a la renta por actividades agropecuarias</p>
														</th>
														<th colSpan="2">
															<p align="center">importe</p>
														</th>
													...
													<tr>
														...
														<td class="borde"><xsl:call-template name="itemNumerico">
																...
																<xsl:with-param name="pValor"><xsl:value-of select="declaracion/detalle/C27"/></xsl:with-param>
																<xsl:with-param name="pModo"><xsl:value-of select="$Modo"/></xsl:with-param>
															</xsl:call-template>
														</td>
													</tr>
													<tr>
														...
														<td class="borde"><xsl:call-template name="itemNumerico">
																...
																<xsl:with-param name="pValor"><xsl:value-of select="declaracion/detalle/C28"/></xsl:with-param>
																<xsl:with-param name="pModo"><xsl:value-of select="$Modo"/></xsl:with-param>
															</xsl:call-template>
														</td>
													</tr>
													<tr>
														...
														<td class="borde"><xsl:call-template name="itemNumerico">
																...
																<xsl:with-param name="pValor"><xsl:value-of select="declaracion/detalle/C29"/></xsl:with-param>
																<xsl:with-param name="pModo"><xsl:value-of select="$Modo"/></xsl:with-param>
															</xsl:call-template>
														</td>
													</tr>
												...
												<tbody>
													...
													<tr>
														...
														<td class="borde"><xsl:call-template name="itemNumerico">
																...
																<xsl:with-param name="pValor"><xsl:value-of select="declaracion/detalle/C30"/></xsl:with-param>
																<xsl:with-param name="pModo"><xsl:value-of select="$Modo"/></xsl:with-param>
															</xsl:call-template>
														</td>
													</tr>
													<tr>
														...
														<td class="borde"><xsl:call-template name="itemNumerico">
																...
																<xsl:with-param name="pValor"><xsl:value-of select="declaracion/detalle/C31"/></xsl:with-param>
																<xsl:with-param name="pModo"><xsl:value-of select="$Modo"/></xsl:with-param>
															</xsl:call-template>
														</td>
													</tr>
													<tr>
														...
														<td class="borde"><xsl:call-template name="itemNumerico">
																...
																<xsl:with-param name="pValor"><xsl:value-of select="declaracion/detalle/C32"/></xsl:with-param>
																<xsl:with-param name="pModo"><xsl:value-of select="$Modo"/></xsl:with-param>
															</xsl:call-template>
														</td>
													</tr>
													<tr>
														...
														<td class="borde"><xsl:call-template name="itemNumerico">
																...
																<xsl:with-param name="pValor"><xsl:value-of select="declaracion/detalle/C33"/></xsl:with-param>
																<xsl:with-param name="pModo"><xsl:value-of select="$Modo"/></xsl:with-param>
															</xsl:call-template>
														</td>
													</tr>
													<tr>
														...
														<td class="borde"><xsl:call-template name="itemNumerico">
																...
																<xsl:with-param name="pValor"><xsl:value-of select="declaracion/detalle/C34"/></xsl:with-param>
																<xsl:with-param name="pModo"><xsl:value-of select="$Modo"/></xsl:with-param>
															</xsl:call-template>
	   </td>
													</tr>
													<tr>
														...
														<td class="borde"><xsl:call-template name="itemNumerico">
																...
																<xsl:with-param name="pValor"><xsl:value-of select="declaracion/detalle/C35"/></xsl:with-param>
																<xsl:with-param name="pModo"><xsl:value-of select="$Modo"/></xsl:with-param>
															</xsl:call-template>
														</td>
														<td class="vacio"/>
													...
													<tr>
														...
														<td class="borde"><xsl:call-template name="itemNumerico">
																...
																<xsl:with-param name="pValor"><xsl:value-of select="declaracion/detalle/C36"/></xsl:with-param>
																<xsl:with-param name="pModo"><xsl:value-of select="$Modo"/></xsl:with-param>
															</xsl:call-template>
														</td>
														<td class="vacio"/>
													...
													<tr>
														...
														<td class="borde"><xsl:call-template name="itemNumerico">
																...
																<xsl:with-param name="pValor"><xsl:value-of select="declaracion/detalle/C37"/></xsl:with-param>
																<xsl:with-param name="pModo"><xsl:value-of select="$Modo"/></xsl:with-param>
															</xsl:call-template>
														</td>
														<td class="vacio"/>
													...
													<tr>
														<td class="borde">i</td>
														<td class="borde">Pago previo o pago a cuenta por el Impuesto a la Renta de Actividades Agropecarias</td>
														<td class="borde">38</td>
														<td class="borde"><xsl:call-template name="itemNumerico">
																<xsl:with-param name="pNombre">C38</xsl:with-param>
																<xsl:with-param name="pValor"><xsl:value-of select="declaracion/detalle/C38"/></xsl:with-param>
																<xsl:with-param name="pModo"><xsl:value-of select="$Modo"/></xsl:with-param>
															</xsl:call-template>
														</td>
														<td class="vacio"/>
													...
													<tr>
														...
														<td class="borde"><xsl:call-template name="itemNumerico">
																...
																<xsl:with-param name="pValor"><xsl:value-of select="declaracion/detalle/C39"/></xsl:with-param>
																<xsl:with-param name="pModo"><xsl:value-of select="$Modo"/></xsl:with-param>
															</xsl:call-template>
														</td>
														<td class="vacio"/>
													...
													<tr>
														...
														<td class="borde"><xsl:call-template name="itemNumerico">
																...
																<xsl:with-param name="pValor"><xsl:value-of select="declaracion/detalle/C40"/></xsl:with-param>
																<xsl:with-param name="pModo"><xsl:value-of select="$Modo"/></xsl:with-param>
															</xsl:call-template>
														</td>
													</tr>
													<tr>
														...
														<td class="borde"><xsl:call-template name="itemNumerico">
																...
																<xsl:with-param name="pValor"><xsl:value-of select="declaracion/detalle/C41"/></xsl:with-param>
																<xsl:with-param name="pModo"><xsl:value-of select="$Modo"/></xsl:with-param>
															</xsl:call-template>
														</td>
														...
														<td class="borde"><xsl:call-template name="itemNumerico">
																...
																<xsl:with-param name="pValor"><xsl:value-of select="declaracion/detalle/C42"/></xsl:with-param>
																<xsl:with-param name="pModo"><xsl:value-of select="$Modo"/></xsl:with-param>
															</xsl:call-template>
														</td>
													</tr>
													<tr>
														<td class="borde">m</td>
														<td class="borde">Saldo a favor del Fisco (Diferencia entre Colunmas de Inc. l, cuando Col. II sea mayor que Col. I)</td>
														<td class="vacio"/>
														<td class="vacio"/>
														<td class="borde">43</td>
														<td class="borde"><xsl:call-template name="itemNumerico">
																<xsl:with-param name="pNombre">C43</xsl:with-param>
																<xsl:with-param name="pValor"><xsl:value-of select="declaracion/detalle/C43"/></xsl:with-param>
																<xsl:with-param name="pModo"><xsl:value-of select="$Modo"/></xsl:with-param>
															</xsl:call-template>
														</td>
													</tr>
													...
													<tr>
														...
														<td class="borde"><xsl:call-template name="itemNumerico">
																...
																<xsl:with-param name="pValor"><xsl:value-of select="declaracion/detalle/C44"/></xsl:with-param>
																<xsl:with-param name="pModo"><xsl:value-of select="$Modo"/></xsl:with-param>
															</xsl:call-template>
														</td>
													</tr>
													<tr>
														...
														<td class="borde"><xsl:call-template name="itemNumerico">
																...
																<xsl:with-param name="pValor"><xsl:value-of select="declaracion/detalle/C45"/></xsl:with-param>
																<xsl:with-param name="pModo"><xsl:value-of select="$Modo"/></xsl:with-param>
															</xsl:call-template>
														</td>
													</tr>
													<tr>
														...
														<td class="borde"><xsl:call-template name="itemNumerico">
																...
																<xsl:with-param name="pValor"><xsl:value-of select="declaracion/detalle/C46"/></xsl:with-param>
																<xsl:with-param name="pModo"><xsl:value-of select="$Modo"/></xsl:with-param>
															</xsl:call-template>
														</td>
													</tr>
