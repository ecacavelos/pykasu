...
function Sumar(formu) {
	...
	try { formu["dynamicProps(C28)"].value = nvl(Math.round(parseFloat(formu["dynamicProps(C27)"].value)));} catch(e){errores++;}
	return errores;
}
								...
								<tr>
									...
									<td vAlign="top" width="636">
										<table class="declaracion">
											<tbody>
												<tr>
													<th>PARA ENTIDADES SIN FINES DE LUCRO QUE REALICEN OPERACIONES EXCLUSIVAMENTE EXONERADAS</th>
												</tr>
											</tbody>
										</table>
									</td>
									...
									<td vAlign="top" width="636">
										<table class="declaracion">
											<tbody>
												...
												<tr>
													<td class="borde">d</td>
													<td class="borde">TOTAL DE INGRESOS EN EL PERIODO QUE SE DECLARA (Inc. a+b+c)</td>
											...
											<tbody>
												...
												<tr>
													...
													<th class="bordevacio" colSpan="2" style="width: 90%">
														<p align="center">a la tasa del 10% -ii-</p>
													</th>
													<th class="bordevacio" colSpan="2">
														<p align="center">a la tasa del 5% -iii-</p>
													</th>
												</tr>
												<tr>
													<td class="borde">a</td>
												...
												<tr>
													<td class="borde">c</td>
													<td class="borde">Otros gastos no incluidos en los incisos anteriores</td>
												...
												<tr>
													<td class="borde">e</td>
													<td class="borde">TOTAL DE EGRESOS REALIZADOS EN EL PERIODO QUE SE DECLARA: (Col. I + II + III;  del Inc. d)</td>
													<td class="vacio"/>
													<td class="vacio"/>
													<td class="vacio"/>
													<td class="vacio"/>
										...
										<table class="declaracion">
											<tbody>
												<tr>
													<th class="bordevacio">INC</th>
													<th class="bordevacio" style="width: 95%">
														<p align="left">RUBRO 3 determinacion de la multa</p>
													</th>
													<th class="bordevacio" colSpan="2">
									...
									<td vAlign="top" width="636">
										<table class="declaracion">
											<tbody>
												...
												<tr>
													<td class="borde">a</td>
													<td class="borde">Saldo definitivo a pagar a favor del Fisco (proviene del Rubro 3, Inc. a)</td>
