...
import py.com.roshka.pykasu.persistence.forms.Form108;
...
@Stateless
@Local ({Form108ManagerInterface.class})
@LocalBinding (jndiBinding="pykasu/Form108Manager/local")
@Remote ({Form108ManagerInterface.class})
@RemoteBinding (jndiBinding="pykasu/Form108Manager/remote")
public class Form108Manager extends GenericFormManagerEJB implements
		Form108ManagerInterface {

	static org.apache.log4j.Logger logger = org.apache.log4j.Logger
			.getLogger(Form108Manager.class);
	
	public static final String FILE_FORM108_XML = "form108.xml"; 
	...
	public Form getForm(String id) throws FormNotFoundException {
		logger.info("get Form 108 whith pre pinted number " + id);

		try{
			Form108 form108;
			form108 = findByPrePrintedNumber(id);
			Form form = null;
			form = form108.loadForm(this);
			return form;
		}catch (Exception e) {
	...
	public String addForm(Form form) throws AddFormException {
    	...
    	try {
    		...
    		Form108 form108 = new Form108(user);
    		
        	form108.fillForm(form);    		
	    	em.persist(form108);
	    	form108.setPrePrintedNumber(form108.getId().toString());
	    	
	    	return form108.getId().toString();
	...
	public void updateForm(Form form) throws UpdateFormException {
		try {
			Form108 form108 = findByPrePrintedNumber(
	...
	public void deteleForm(String id) throws FormDeleteException {
    	try {
    		Form108 form108 = findByPrePrintedNumber(id);
			em.remove(form108);
		} catch (FormNotFoundException e) {
			e.printStackTrace();
	...
	protected String getFormClassName() {
		return TaxForm.FORM_108_CLASS_NAME;
	}

	@Override
	protected String getXmlFormRepresentation() {
		return FILE_FORM108_XML;
	}

	protected Form108 findByPrePrintedNumber(String prePrintedNumber)
	...
	try{
		...
		Form108 form108 = (Form108) em.createQuery("from Form108 where prePrintedNumber like :ppn and businessCompany = :bc")
