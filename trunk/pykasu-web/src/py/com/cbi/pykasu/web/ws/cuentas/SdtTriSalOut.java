 ...
 *         &lt;element name="Detalle" type="{services}ArrayOfSdt_tri_sal_out_det"/>
 *       &lt;/all>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class SdtTriSalOut {
	...
	protected ArrayOfSdtTriSalOutDet detalle;
	 ...
	 * 
	 * @return possible object is {@link ArrayOfSdtTriSalOutDet }
	 * 
	 */
	public ArrayOfSdtTriSalOutDet getDetalle() {
		return detalle;
	}
	 ...
	 * 
	 * @param value
	 *            allowed object is {@link ArrayOfSdtTriSalOutDet }
	 * 
	 */
	public void setDetalle(ArrayOfSdtTriSalOutDet value) {
		this.detalle = value;
	}
