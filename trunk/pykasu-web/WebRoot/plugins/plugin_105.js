...
function onloadForm(){
	...
	disabledByCondition105(document.getElementById('c18'), 'c30');
	disabledByCondition105(document.getElementById('c19'), 'c31');
	disabledByCondition105(document.getElementById('c20'), 'c32');		
	disabledByCondition105(document.getElementById('c21'), 'c33');		
...
function calcPorcentajeMoras(){
	...
	if(CONTRAVENSION_SMOV && CONTRAVENSION_CMOV != null){
		document.getElementById('c92').value =  CONTRAVENSION_CMOV * norectificativa;		
		if(document.getElementById('c92').value != null)
  		   colocarpuntos(document.getElementById('c92'));
	}
	refreshVars();
	TRGc94();
	TRGc96();
	TRGc96_0();
	var tmp92 =	getValueFormatless('c92');
	var tmp96 = getValueFormatless('c96');	
	var op = tmp96 - tmp92;
	if(op < 0){
		op = 0;
	}
	...
	if (PORC_MORA && PORC_MORA != null){
		document.getElementById('c97').value =  (PORC_MORA * op).toFixed(0);
		if(document.getElementById('c97').value < 0){
			document.getElementById('c97').value  = 0;
		}
		if(document.getElementById('c97').value != null)
  		   colocarpuntos(document.getElementById('c97'));
	}		
	if (PORC_INTERES && PORC_INTERES != null){
		document.getElementById('c98').value =  (PORC_INTERES * op).toFixed(0);
		if(document.getElementById('c98').value < 0){
			document.getElementById('c98').value  = 0;
		}
		if(document.getElementById('c98').value != null)
  		   colocarpuntos(document.getElementById('c98'));
	}
...
function beforeSave(){
	...
	var isEmpty = true;
	for (i = 10 ; i <= 124 ; i++) // Recorrer todas las celdas
	{
