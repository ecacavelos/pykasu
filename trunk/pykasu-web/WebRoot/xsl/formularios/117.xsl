			...
			<body>
				...
				<table class="declaracion">
					<tbody>
						...
						<tr>
							<th class="bordevacio">PARA EMPRESAS UNIPERSONALES QUE REALICEN ACTIVIDADES GRAVADAS POR EL IMPUESTO Y QUE LIQUIDEN EL IMPUESTO AL VALOR AGREGADO POR DETERMINACION DE LA RENTA NETA REAL Y BASE DE CALCULO DEL ANTICIPO</th>
						</tr>
						<tr>
							<td colSpan="2">
								<table width="100%">
																...
																<table class="declaracion">
																	<tbody>
																		<tr>
																			<th>INC</th>
																			<th style="width: 95%">
																				<p align="left">RUBRO 1 DETERMINACION DE LA RENTA NETA REAL DEL PERIODO</p>
																			</th>
																			<th colSpan="2">
