...
function Sumar(formu) {
	...
	try { formu["dynamicProps(C8)"].value = nvl(Math.round(parseFloat(formu["dynamicProps(C5)"].value) * 0.15));} catch(e){errores++;}
	...
	try { formu["dynamicProps(C11)"].value = nvl(Math.round(parseFloat(formu["dynamicProps(C10)"].value) * (buscartasa(11) / 100)));} catch(e){errores++;}
	try { formu["dynamicProps(C17)"].value = nvl(Math.round(elegir(calcularmulta(111,parseFloat(formu["dynamicProps(C11)"].value)),0,si(parseFloat(formu["dynamicProps(C17)"].value)>0,50000,0),calcularmulta(111,parseFloat(formu["dynamicProps(C11)"].value)))));} catch(e){errores++;}
	try { formu["dynamicProps(C18)"].value = nvl(Math.round(mayor(parseFloat(formu["dynamicProps(C12)"].value)+parseFloat(formu["dynamicProps(C13)"].value)+parseFloat(formu["dynamicProps(C14)"].value)+parseFloat(formu["dynamicProps(C15)"].value)+parseFloat(formu["dynamicProps(C16)"].value)-parseFloat(formu["dynamicProps(C11)"].value)-parseFloat(formu["dynamicProps(C17)"].value),0)));} catch(e){errores++;}
	try { formu["dynamicProps(C19)"].value = nvl(Math.round(calcularmora(mayor(parseFloat(formu["dynamicProps(C11)"].value)-(parseFloat(formu["dynamicProps(C12)"].value)+parseFloat(formu["dynamicProps(C13)"].value)+parseFloat(formu["dynamicProps(C14)"].value)+parseFloat(formu["dynamicProps(C15)"].value)+parseFloat(formu["dynamicProps(C16)"].value)),0))));} catch(e){errores++;}
	try { formu["dynamicProps(C20)"].value = nvl(Math.round(calcularinteres(mayor(parseFloat(formu["dynamicProps(C11)"].value)-(parseFloat(formu["dynamicProps(C12)"].value)+parseFloat(formu["dynamicProps(C13)"].value)+parseFloat(formu["dynamicProps(C14)"].value)+parseFloat(formu["dynamicProps(C15)"].value)+parseFloat(formu["dynamicProps(C16)"].value)),0))));} catch(e){errores++;}
	try { formu["dynamicProps(C21)"].value = nvl(Math.round(mayor(parseFloat(formu["dynamicProps(C11)"].value)-parseFloat(formu["dynamicProps(C12)"].value)-parseFloat(formu["dynamicProps(C13)"].value)-parseFloat(formu["dynamicProps(C14)"].value)-parseFloat(formu["dynamicProps(C15)"].value)-parseFloat(formu["dynamicProps(C16)"].value)+parseFloat(formu["dynamicProps(C17)"].value)+parseFloat(formu["dynamicProps(C19)"].value)+parseFloat(formu["dynamicProps(C20)"].value),0)));} catch(e){errores++;}
	try { formu["dynamicProps(C29)"].value = nvl(Math.round(parseFloat(formu["dynamicProps(C22)"].value)+parseFloat(formu["dynamicProps(C23)"].value)+parseFloat(formu["dynamicProps(C24)"].value)+parseFloat(formu["dynamicProps(C25)"].value)+parseFloat(formu["dynamicProps(C26)"].value)+parseFloat(formu["dynamicProps(C27)"].value)));} catch(e){errores++;}
	return errores;
}
									...
									<td vAlign="top" width="636">
										<table class="declaracion">
											<tbody>
												<tr>
													<th>
														<p align="left">PARA EMPRESAS UNIPERSONALES QUE REALICEN ACTIVIDADES COMERCIALES, INDUSTRIALES O DE SERVICIOS Y CAREZCAN DE REGISTROS CONTABLES</p>
													</th>
												</tr>
											</tbody>
										</table>
											...
											<tbody>
												<tr>
													...
													<th class="bordevacio" style="width: 90%">
														<p align="left">RUBRO 1 DETERMINACION DE LA RENTA NETA PRESUNTA</p>
													</th>
													<th class="bordevacio" colSpan="2">
														<p align="center">COSTO O INGRESO -i-</p>
													</th>
													<th class="bordevacio">
												...
												<tr>
													<td class="borde">a</td>
													<td class="borde">Empresas Constructoras</td>
												...
												<tr>
													<td class="borde">b</td>
													<td class="borde">Otros Contribuyentes que no llevan contabilidad</td>
									...
									<td vAlign="top" width="636">
										<table class="declaracion">
											<tbody>
												...
												<tr>
													<td class="borde">a</td>
													<td class="borde">Impuesto Liquidado (30% del Rubro 1 Inc c. Col III)</td>
													<td class="vacio"/>
													<td class="vacio"/>
												...
												<tr>
													<td class="borde">h</td>
													<td class="borde">SUB TOTALES (Inc. b+c+d+e+f a Col. I, Inc. a+g a Col. II)</td>
													<td class="vacio"/>
													<td class="borde"/>
													<td class="vacio"/>
													<td class="borde"/>
												...
												<tr>
													<td class="borde">l</td>
													<td class="borde">Intereses del resultado de Inc. j menos Inc. g (Sólo se calculará cuando Inc. j sea mayor que Inc. g) </td>
													<td class="vacio"/>
													<td class="vacio"/>
											...
											<tbody>
												<tr>
													...
													<th class="bordevacio" style="width: 95%">
														<p align="left">RUBRo 3 datos complementarios de la actividad</p>
													</th>
													<th class="bordevacio" colSpan="2">
												...
												<tr>
													<td class="borde">a</td>
													<td class="borde">Gastos de alquiler de inmuebles (locales, depósitos, etc.) afectados a la actividad</td>
												...
												<tr>
													<td class="borde">b</td>
													<td class="borde">Gastos de energía eléctrica, teléfono, agua y tasas municipales.</td>
												...
												<tr>
													<td class="borde">c</td>
													<td class="borde">Impuesto inmobiliario</td>
												...
												<tr>
													<td class="borde">d</td>
													<td class="borde">Remuneraciones brutas por sueldos y jornales, aguinaldos, bonificaciones y otras gratificaciones</td>
												...
												<tr>
													<td class="borde">f</td>
													<td class="borde">Otros gastos propios de la actividad no incluídos en los incisos anteriores</td>
												...
												<tr>
													<td class="borde">g</td>
													<td class="borde">Cantidad de personal ocupado al cierre del ejercicio (empleados y obreros)</td>
												...
												<tr>
													<td class="borde">h</td>
													<td class="borde">Total de control (Inc. a+b+c+d+e+f)        </td>
