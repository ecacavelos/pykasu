						...
						<tr>
							<td>
								<xsl:call-template name="cabeceraDeclaracionesClausura">
									<xsl:with-param name="pFormulario">850</xsl:with-param>
														...
														<tbody>
															...
															<tr>
																...
																<th class="bordevacio" colSpan="2" style="width: 90%">
																	<p align="center">10% -ii-</p>
																</th>
																<th class="bordevacio" colSpan="2">
																	<p align="center">5% -iii-</p>
																</th>
															</tr>
															<tr>
																<td class="borde">a</td>
																<td class="borde">Enajenación de Bienes y Prestación de Servicios con tasa del 10%</td>
															...
															<tr>
																<td class="borde">b</td>
																<td class="borde">Enajenaci�n de Bienes y Prestaci�n de Servicios gravadas con tasa del 5%</td>
												...
												<td vAlign="top" width="636">
													<table class="declaracion">
														<tbody>
															...
															<tr>
																<td class="borde">c</td>
																<td class="borde">Con Crédito Fiscal del 10%, indistintamente afectados a operaciones en el Mercado Interno no gravadas o exentas</td>
															...
															<tr>
																<td class="borde">d</td>
																<td class="borde">Con Crédito Fiscal del 5%, indistintamente afectados a operaciones en el Mercado Interno no gravadas o exentas</td>
													...
													<table class="declaracion">
														<tbody>
															<tr>
																<th class="bordevacio"/>
																<th class="bordevacio" style="width: 95%">
																	<p align="left">uso interno - identificacion del credito tributario</p>
																</th>
																<th class="bordevacio" colSpan="2">
																	<p align="center"> </p>
																</th>
															...
															<tr class="borde">
																<td/>
																<td>Número de Recibo expedido por la Administración Tributaria</td>
												...
												<td vAlign="top" width="636">
													<table class="declaracion">
														<tbody>
															...
															<tr>
																<td class="borde">e</td>
																<td class="borde">Total de Crédito Fiscal por operaciones de Exportación y asimilables.</td>
																<td class="vacio"/>
																<td class="vacio"/>
															...
															<tr>
																<td class="borde">f</td>
																<td class="borde">Saldo a favor del Contribuyente del período anterior (proviene del Inc. J, Col. II del Rubro 4 de la Declaración Jurada del periodo anterior.)</td>
																<td class="vacio"/>
																<td class="vacio"/>
															...
															<tr>
																<td class="borde">g</td>
																<td class="borde">TOTAL ACUMULADO DE CREDITO FISCAL POR EXPORTACIONES Y ASIMILABLES (Inc. e+f, Col. II)</td>
																<td class="vacio"/>
																<td class="vacio"/>
															...
															<tr>
																<td class="borde">j</td>
																<td class="borde">SALDO A FAVOR DEL EXPORTADOR Y ASIMILABLES: (Inc. g - (Col. II Inc. h+i))</td>
																<td class="vacio"/>
																<td class="vacio"/>
												...
												<td vAlign="top" width="636">
													<table class="declaracion">
														<tbody>
															...
															<tr>
																<th class="bordevacio" colSpan="2">
																	<p align="center">10% -i-</p>
																</th>
																<th class="bordevacio" colSpan="2" style="width: 90%">
																	<p align="center">5% -ii-</p>
																</th>
															</tr>
															<tr>
																<td class="borde">a</td>
												...
												<td vAlign="top" width="636">
													<table class="declaracion">
														<tbody>
															...
															<tr>
																<td class="borde">e</td>
																<td class="borde">Multa por presentar la Declaraci�n Jurada con posterioridad al vencimiento</td>
																<td class="vacio"/>
																<td class="vacio"/>
															...
															<tr>
																<td class="borde">g</td>
																<td class="borde">
																	<p>Saldo a favor del Contribuyente (Diferencia entre el Inc. f Col. I y II, cuando Col. I sea mayor que Col. II)</p>
																</td>
															...
															<tr>
																<td class="borde">h</td>
																<td class="borde">Saldo a favor del Fisco (Diferencia entre el Inc. f Col. I y II, cuando Col. II sea mayor que Col. I)</td>
																<td class="vacio"/>
																<td class="vacio"/>
															...
															<tr>
																<td class="borde">i</td>
																<td class="borde">Multa por Mora (.........% del resultado del Inc. h menos el Inc. e) (Sólo se calculará cuando Inc. h sea mayor que Inc. e)</td>
																<td class="vacio"/>
																<td class="vacio"/>
															...
															<tr>
																<td class="borde">j</td>
																<td class="borde">Intereses (.........% del resultado del Inc. h menos el Inc. e) (Sólo se calculará cuando Inc. h sea mayor que Inc. e)</td>
																<td class="vacio"/>
																<td class="vacio"/>
															...
															<tr>
																<td class="borde">k</td>
																<td class="borde">Pago con Certificado de Cr�dito Tributario expedido por la Administración</td>
