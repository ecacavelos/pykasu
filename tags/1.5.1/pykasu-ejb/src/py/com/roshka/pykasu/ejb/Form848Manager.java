...
import py.com.roshka.pykasu.persistence.forms.Form848;
...
@Stateless
@Local ({Form848ManagerInterface.class})
@LocalBinding (jndiBinding="pykasu/Form848Manager/local")
@Remote ({Form848ManagerInterface.class})
@RemoteBinding (jndiBinding="pykasu/Form848Manager/remote")
public class Form848Manager extends GenericFormManagerEJB implements
		Form848ManagerInterface {

	static org.apache.log4j.Logger logger = org.apache.log4j.Logger
			.getLogger(Form848Manager.class);
	
	public static final String FILE_FORM848_XML = "form848.xml"; 
	...
	public void updateForm(Form form) throws UpdateFormException {
		try {
			Form848 form848 = findByPrePrintedNumber(
	...
	protected String getFormClassName() {
		return TaxForm.FORM_848_CLASS_NAME;
	}

	@Override
	protected String getXmlFormRepresentation() {
		return FILE_FORM848_XML;
	}

	protected Form848 findByPrePrintedNumber(String prePrintedNumber)
	...
	try{
		...
		Form848 form848 = (Form848) em.createQuery("from Form848 where prePrintedNumber like :ppn and businessCompany = :bc")
