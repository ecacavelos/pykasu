...
function Sumar(formu) {
	...
	try { formu["dynamicProps(C19)"].value = nvl(Math.round(parseFloat(formu["dynamicProps(C12)"].value)-parseFloat(formu["dynamicProps(C18)"].value)));} catch(e){errores++;}
	try { formu["dynamicProps(C24)"].value = nvl(Math.round(parseFloat(formu["dynamicProps(C22)"].value)-parseFloat(formu["dynamicProps(C23)"].value)));} catch(e){errores++;}
	...
	try { formu["dynamicProps(C31)"].value = nvl(Math.round(parseFloat(formu["dynamicProps(C24)"].value)-parseFloat(formu["dynamicProps(C30)"].value)));} catch(e){errores++;}
	...
	try { formu["dynamicProps(C46)"].value = nvl(Math.round(parseFloat(formu["dynamicProps(C46)"].value)));} catch(e){errores++;}
	try { formu["dynamicProps(C47)"].value = nvl(Math.round(parseFloat(formu["dynamicProps(C47)"].value)));} catch(e){errores++;}
	try { formu["dynamicProps(C48)"].value = nvl(Math.round(parseFloat(formu["dynamicProps(C48)"].value)));} catch(e){errores++;}
	try { formu["dynamicProps(C49)"].value = nvl(Math.round(parseFloat(formu["dynamicProps(C49)"].value)));} catch(e){errores++;}
	try { formu["dynamicProps(C50)"].value = nvl(Math.round(parseFloat(formu["dynamicProps(C50)"].value)));} catch(e){errores++;}
	try { formu["dynamicProps(C51)"].value = nvl(Math.round(parseFloat(formu["dynamicProps(C51)"].value)));} catch(e){errores++;}
	try { formu["dynamicProps(C52)"].value = nvl(Math.round(parseFloat(formu["dynamicProps(C52)"].value)));} catch(e){errores++;}
	try { formu["dynamicProps(C53)"].value = nvl(Math.round(parseFloat(formu["dynamicProps(C53)"].value)));} catch(e){errores++;}
	try { formu["dynamicProps(C54)"].value = nvl(Math.round(parseFloat(formu["dynamicProps(C54)"].value)));} catch(e){errores++;}
	try { formu["dynamicProps(C55)"].value = nvl(Math.round(parseFloat(formu["dynamicProps(C55)"].value)));} catch(e){errores++;}
	try { formu["dynamicProps(C56)"].value = nvl(Math.round(parseFloat(formu["dynamicProps(C56)"].value)));} catch(e){errores++;}
	try { formu["dynamicProps(C57)"].value = nvl(Math.round(parseFloat(formu["dynamicProps(C57)"].value)));} catch(e){errores++;}
	...
	try { formu["dynamicProps(C94)"].value = nvl(Math.round((parseFloat(formu["dynamicProps(C21)"].value)+parseFloat(formu["dynamicProps(C33)"].value)+parseFloat(formu["dynamicProps(C39)"].value)+parseFloat(formu["dynamicProps(C45)"].value)+parseFloat(formu["dynamicProps(C58)"].value)+parseFloat(formu["dynamicProps(C71)"].value)+parseFloat(formu["dynamicProps(C88)"].value))-parseFloat(formu["dynamicProps(C93)"].value)));} catch(e){errores++;}
	...
	try { formu["dynamicProps(C145)"].value = nvl(Math.round(parseFloat(formu["dynamicProps(C140)"].value)+parseFloat(formu["dynamicProps(C141)"].value)+parseFloat(formu["dynamicProps(C142)"].value)+parseFloat(formu["dynamicProps(C143)"].value)+parseFloat(formu["dynamicProps(C144)"].value)));} catch(e){errores++;}
	try { formu["dynamicProps(C146)"].value = nvl(Math.round(parseFloat(formu["dynamicProps(C139)"].value)-parseFloat(formu["dynamicProps(C145)"].value)));} catch(e){errores++;}
	try { formu["dynamicProps(C153)"].value = nvl(Math.round(parseFloat(formu["dynamicProps(C153)"].value)-parseFloat(formu["dynamicProps(C154)"].value)));} catch(e){errores++;}
	...
	try { formu["dynamicProps(C161)"].value = nvl(Math.round(parseFloat(formu["dynamicProps(C156)"].value)+parseFloat(formu["dynamicProps(C157)"].value)+parseFloat(formu["dynamicProps(C158)"].value)+parseFloat(formu["dynamicProps(C159)"].value)+parseFloat(formu["dynamicProps(C160)"].value)));} catch(e){errores++;}
	try { formu["dynamicProps(C162)"].value = nvl(Math.round(parseFloat(formu["dynamicProps(C155)"].value)-parseFloat(formu["dynamicProps(C161)"].value)));} catch(e){errores++;}
	...
	try { formu["dynamicProps(C177)"].value = nvl(Math.round(parseFloat(formu["dynamicProps(C172)"].value)+parseFloat(formu["dynamicProps(C173)"].value)+parseFloat(formu["dynamicProps(C174)"].value)+parseFloat(formu["dynamicProps(C175)"].value)+parseFloat(formu["dynamicProps(C176)"].value)));} catch(e){errores++;}
	try { formu["dynamicProps(C178)"].value = nvl(Math.round(parseFloat(formu["dynamicProps(C171)"].value)-parseFloat(formu["dynamicProps(C177)"].value)));} catch(e){errores++;}
...
function Cerar(formu) {
	...
	try { if(formu["dynamicProps(C158)"].value == "") formu["dynamicProps(C158)"].value = 0;} catch(e) {errores++;} 
									...
									<td vAlign="top" width="636">
										<table class="declaracion">
											<tbody>
												...
												<tr>
													<td class="borde">d</td>
													<td class="borde">CARACTER DEL INMUEBLE:Indicar con el número, según lo que corresponda 1Propio; 2 Arrendado; 3 Poseedor a cualquier Tí­tulo; 4 Ocupado sin arrendamiento; 5 Aparcería; 6 Societarios; 7 Otros.</td>
												...
												<tr>
													<td class="borde">n</td>
													<td class="borde">TOTAL DE SUPERFICIES DEDUCIBLES (Suma del Inc. i al m)</td>
