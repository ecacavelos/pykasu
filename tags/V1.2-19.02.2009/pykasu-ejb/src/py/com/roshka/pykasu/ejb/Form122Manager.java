...
import py.com.roshka.pykasu.persistence.forms.Form122;
...
@Stateless
@Local ({Form122ManagerInterface.class})
@LocalBinding (jndiBinding="pykasu/Form122Manager/local")
@Remote ({Form122ManagerInterface.class})
@RemoteBinding (jndiBinding="pykasu/Form122Manager/remote")
public class Form122Manager extends GenericFormManagerEJB implements
		Form122ManagerInterface {

	static org.apache.log4j.Logger logger = org.apache.log4j.Logger
			.getLogger(Form122Manager.class);
	
	public static final String FILE_FORM122_XML = "form122.xml"; 
	...
	public Form getForm(String id) throws FormNotFoundException {
		logger.info("get Form 122 whith pre pinted number " + id);

		try{
			Form122 form122;
			form122 = findByPrePrintedNumber(id);
			Form form = null;
			form = form122.loadForm(this);
			return form;
		}catch (Exception e) {
	...
	public String addForm(Form form) throws AddFormException {
    	logger.info("------------> Adding a new Form 122");
    	try {
    		...
    		Form122 form122 = new Form122(user);
    		
        	form122.fillForm(form);    		
	    	em.persist(form122);
	    	form122.setPrePrintedNumber(form122.getId().toString());
	    	
	    	return form122.getId().toString();
	...
	public void updateForm(Form form) throws UpdateFormException {
		try {
			Form122 form122 = findByPrePrintedNumber(
	...
	public void deteleForm(String id) throws FormDeleteException {
    	try {
    		Form122 form122 = findByPrePrintedNumber(id);
			em.remove(form122);
		} catch (FormNotFoundException e) {
			e.printStackTrace();
	...
	protected String getFormClassName() {
		return TaxForm.FORM_122_CLASS_NAME;
	}

	@Override
	protected String getXmlFormRepresentation() {
		return FILE_FORM122_XML;
	}

	protected Form122 findByPrePrintedNumber(String prePrintedNumber)
	...
	try{
		...
		Form122 form122 = (Form122) em.createQuery("from Form122 where prePrintedNumber like :ppn and businessCompany = :bc")
