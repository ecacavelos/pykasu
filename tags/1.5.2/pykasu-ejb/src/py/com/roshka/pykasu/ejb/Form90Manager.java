...
import py.com.roshka.pykasu.persistence.forms.Form90;
...
@Stateless
@Local ({Form90ManagerInterface.class})
@LocalBinding (jndiBinding="pykasu/Form90Manager/local")
@Remote ({Form90ManagerInterface.class})
@RemoteBinding (jndiBinding="pykasu/Form90Manager/remote")
public class Form90Manager extends GenericFormManagerEJB implements
		Form90ManagerInterface {

	static org.apache.log4j.Logger logger = org.apache.log4j.Logger
			.getLogger(Form90Manager.class);
	
	public static final String FILE_FORM90_XML = "form90.xml"; 
	...
	public Form getForm(String id) throws FormNotFoundException {
		logger.info("get Form 90 whith pre pinted number " + id);

		try{
			Form90 form90;
			form90 = findByPrePrintedNumber(id);
			Form form = null;
			form = form90.loadForm(this);
			return form;
		}catch (Exception e) {
	...
	public String addForm(Form form) throws AddFormException {
    	...
    	try {
    		...
    		Form90 form90 = new Form90(user);
    		
        	form90.fillForm(form);    		
	    	em.persist(form90);
	    	form90.setPrePrintedNumber(form90.getId().toString());
	    	
	    	return form90.getId().toString();
	...
	public void updateForm(Form form) throws UpdateFormException {
		try {
			Form90 form90 = findByPrePrintedNumber(
	...
	public void deteleForm(String id) throws FormDeleteException {
    	try {
    		Form90 form90 = findByPrePrintedNumber(id);
			em.remove(form90);
		} catch (FormNotFoundException e) {
			e.printStackTrace();
	...
	protected String getFormClassName() {
		return TaxForm.FORM_90_CLASS_NAME;
	}

	@Override
	protected String getXmlFormRepresentation() {
		return FILE_FORM90_XML;
	}

	protected Form90 findByPrePrintedNumber(String prePrintedNumber)
	...
	try{
		...
		Form90 form90 = (Form90) em.createQuery("from Form90 where prePrintedNumber like :ppn and businessCompany = :bc")
