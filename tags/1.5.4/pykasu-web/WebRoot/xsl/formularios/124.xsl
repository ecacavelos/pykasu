										...
										<tr>
											...
											<td vAlign="top" width="636">
												<table class="declaracion">
													<tbody>
														<tr>
															<th class="bordevacio">PARA EMPRESAS UNIPERSONALES QUE ACTUEN COMO AGENTES DE RETENCION DE FORMA OCASIONAL. </th>
														</tr>
													</tbody>
												</table>
											</td>
													...
													<tbody>
														<tr>
															...
															<th class="bordevacio" style="width: 95%">
																<p align="left">RUBRO 1 IMPUESTO AL VALOR AGREGADO </p>
															</th>
														...
														<tr>
															<td class="borde">a</td>
															<td class="borde">
																Retenciones en carácter de Pago Único y Definitivo por acreditamiento de retribuciones a personas o entidades del exterior que no posean sucursales en el país                                          </td>
														...
														<tr>
															<td class="borde">b</td>
														  <td class="borde">Retenciones en carácter de Pago Único y Definitivo por la enajenación de bienes inmuebles, efectuados por aquellos designados como agentes de retención por la Administración Tributaria </td>
														...
														<tr>
															<td class="borde">c</td>
															<td class="borde">Retenciones en carácter de Pago Único y Definitivo por acreditamientos efectuados y no incluidos en los incisos anteriores </td>
														...
														<tr>
															<td class="borde">d</td>
															<td class="borde">Retenciones en carácter de pago a cuenta para Contribuyentes obligados por el Impuesto </td>
														...
														<tr>
															<td class="borde">e</td>
															<td class="borde">Total retenciones (Inc. a+b+c+d) </td>
											...
											<td vAlign="top" width="636">
												<table class="declaracion">
													<tbody>
														...
														<tr>
															<td class="borde">a</td>
															<td class="borde">Retenciones en concepto de Impuesto al Valor Agregado (Proviene del Rubro 1, Inc. e) </td>
														...
														<tr>
															...
															<td class="borde">
															<xsl:call-template name="itemNumerico"><xsl:with-param name="pNombre">C16</xsl:with-param><xsl:with-param name="pValor"><xsl:value-of select="declaracion/detalle/C16"/></xsl:with-param><xsl:with-param name="pModo"><xsl:value-of select="$Modo"/></xsl:with-param></xsl:call-template>															</td><td class="vacio" colspan="2"/>
														</tr>
														<tr>
															<td class="borde">c</td>
														...
														<tr>
															<td class="borde">d</td>
															<td class="borde">SUB TOTALES (Inc. b+c, Col. I), (Inc. a+d, Col. II) </td>
														...
														<tr>
															<td class="borde">f</td>
															<td class="borde">Saldo a favor del Fisco (Diferencia entre Columnas del Inc. e, cuando Col. II sea mayor que Col. I) </td><td colspan="2" class="vacio"/>
													...
													<tr>
														<td class="borde">i</td>
														<td class="borde">Saldo definitivo a pagar a favor del Fisco (Inc. f+g+h) </td>
														<td colspan="2" class="vacio"/>
