...
<font size=2 color="336699" face="verdana"><b>Assign Roles to User</b></font><br><br>
<table border="0" style="margin-top: 0; padding-top: 0">
 <tr>
  <td><font size="1" face=verdana>Available Roles</td>
  <td>&nbsp;</td>
  <td><font size="1" face=verdana>Assigned Roles</td>
 </tr>
 <tr>
  <td><select multiple size="8" name="list1" onDblClick="opt.transferRight()"><%=bean.getLeftSideOptions()%></select></td>
  <td valign=middle align="center">
  	<INPUT TYPE="button" VALUE="&gt;&gt;" ONCLICK="opt.transferRight()"><BR><BR>
	<INPUT TYPE="button" VALUE="All &gt;&gt;" ONCLICK="opt.transferAllRight()"><BR><BR>
	<INPUT TYPE="button" VALUE="&lt;&lt;" ONCLICK="opt.transferLeft()"><BR><BR>
	<INPUT TYPE="button" VALUE="All &lt;&lt;" ONCLICK="opt.transferAllLeft()">
  </td>
  <td><select multiple size="8" name="list2" onDblClick="opt.transferLeft()"><%=bean.getRightSideOptions()%></select></td>
 </tr>
</table>
</div>
*/
